...
<script>
    ...
    export default {
        ...
        asyncData ({ store, route}) {
            ...
            return Promise.all([store.dispatch('getUserInfo'), store.dispatch('getRecentComment'), store.dispatch('getRecentPost'), store.dispatch('setTypeList'), store.dispatch('getBlogList', {page})]);
        },
        computed: {
            ...mapGetters({
                types: 'getTypeList',
